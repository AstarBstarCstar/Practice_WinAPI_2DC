...
void TimeManager::Update()
{
	...
	m_dDT = (double)(m_llCurCount.QuadPart - m_llPrevCount.QuadPart) /(double)m_llFreq.QuadPart;
	m_llPrevCount = m_llCurCount;/*이전 프레임을 현재 프레임 카운팅 값으로 넣습니다*/

	++UpdateCount;//업데이트 카운트를 1 증가시킵니다
	UpdateOneSec += m_dDT;//델타값이 1이 되었단 소리는 1초가 지났단 소리
